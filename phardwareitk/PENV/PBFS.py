...
class PBFS_DriveData:
	def __init__(self):
		...
		self.permission_table_entry_size:int = 12  # Size of each permission table entry in bytes
	...
	def reload(self) -> None:
		...
		file_table_data = data[ftoffset:ftoffset + entries*self.file_table_entry_size]  # Read file table
		...
		for i in range(entries):
			...
			if (file_entry[1] << 32) | file_entry[2] == self.dummy_offset:
